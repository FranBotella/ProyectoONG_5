...
<div class="container text-center p-1">
      ...
      <div class="form-group">
			...
			<div id="BTNrecuperarContrasenya">
				...
				<input id="BTN-BTNrecuperarContrasenya"  TYPE="submit" NAME="brecuperarContrasenya" class='btn btn-danger' VALUE="recuperarContraseña"><br>
				</div>
			</div>
		</form>
	</div>
    ...
    <input id="BTN-BTNuevaContrasenya"  class="btn btn-danger" TYPE="submit" NAME="bNuevaContrasenya" VALUE="Confirmar"><br> 
    </form>  
    </div>
<?php }?>
